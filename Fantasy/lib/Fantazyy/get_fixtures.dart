...
//
//     final getFixtures = getFixturesFromJson(jsonString);

import 'dart:convert';

List<GetFixtures> getFixturesFromJson(String str) => List<GetFixtures>.from(json.decode(str).map((x) => GetFixtures.fromJson(x)));

String getFixturesToJson(List<GetFixtures> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GetFixtures {
  ...
  factory GetFixtures.fromJson(Map<String, dynamic> json) => GetFixtures(
