      ...
      Container(
         decoration: BoxDecoration(
          ...
          itemBuilder: (context, index){
            return AssistsWidget(id:results[index].player.id, name:results[index].player.name,lastname: results[index].player.lastname, image:results[index].player.photo, club:results[index].statistics[0].team.name,
