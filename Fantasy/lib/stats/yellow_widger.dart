...
class YellowWidget extends StatefulWidget  {
  ...
  YellowWidget({this.id,this.name, this.lastname,this.image, this.club, this.position,
    this.nationality, this.age, this.matches, this.goals, this.assists, this.saves,this.yellow});

  @override
  _PlayerWidgetState createState() => _PlayerWidgetState();
}

class _PlayerWidgetState extends State<YellowWidget> {
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget> [
                    ...
                    Text("Yellow Cards: "+this.widget.yellow, style: TextStyle( fontWeight:FontWeight.bold,
                      fontSize: 18.0,
                    )),
                    const SizedBox(height: 5.0, ),
                  ],
