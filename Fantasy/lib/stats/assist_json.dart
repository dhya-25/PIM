...
//
//     final assistsJson = assistsJsonFromJson(jsonString);

import 'dart:convert';

List<AssistsJson> assistsJsonFromJson(String str) => List<AssistsJson>.from(json.decode(str).map((x) => AssistsJson.fromJson(x)));

String assistsJsonToJson(List<AssistsJson> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class AssistsJson {
  ...
  factory AssistsJson.fromJson(Map<String, dynamic> json) => AssistsJson(
...
enum Position { ATTACKER, MIDFIELDER, DEFENDER }
