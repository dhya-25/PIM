...
//
//     final redJson = redJsonFromJson(jsonString);

import 'dart:convert';

List<RedJson> redJsonFromJson(String str) => List<RedJson>.from(json.decode(str).map((x) => RedJson.fromJson(x)));

String redJsonToJson(List<RedJson> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class RedJson {
  ...
  factory RedJson.fromJson(Map<String, dynamic> json) => RedJson(
