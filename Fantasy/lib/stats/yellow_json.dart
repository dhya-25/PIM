...
//
//     final yellowJson = yellowJsonFromJson(jsonString);

import 'dart:convert';

List<YellowJson> yellowJsonFromJson(String str) => List<YellowJson>.from(json.decode(str).map((x) => YellowJson.fromJson(x)));

String yellowJsonToJson(List<YellowJson> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class YellowJson {
  ...
  factory YellowJson.fromJson(Map<String, dynamic> json) => YellowJson(
...
enum Position { MIDFIELDER, DEFENDER, ATTACKER }
