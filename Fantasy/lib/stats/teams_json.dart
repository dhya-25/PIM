...
class TeamsJson implements Comparable{
  TeamsJson({
    this.league,
  });
  ...
  @override
  int compareTo(other) {
    if (this.league.standings[0][0].all.goals.goalsFor < other.league.standings[0][0].all.goals.goalsFor) {
      return 1;
    }

    else if (this.league.standings[0][0].all.goals.goalsFor < other.league.standings[0][0].all.goals.goalsFor) {
      return -1;
    }
