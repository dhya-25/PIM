...
import 'package:Fantasy/stats/goals_json.dart';
...
class _AssistsState extends State<Scorers> {

  List<GoalsJson> results = [];
      ...
      Container(
         decoration: BoxDecoration(
          ...
          itemBuilder: (context, index){
            return GoalsWidget(id:results[index].player.id, name:results[index].player.name,lastname: results[index].player.lastname, image:results[index].player.photo, club:results[index].statistics[0].team.name,
                ...
                saves:results[index].statistics[0].goals.saves.toString(),rating:results[index].statistics[0].games.rating);
          },
