...
//
//     final goalsJson = goalsJsonFromJson(jsonString);

import 'dart:convert';

List<GoalsJson> goalsJsonFromJson(String str) => List<GoalsJson>.from(json.decode(str).map((x) => GoalsJson.fromJson(x)));

String goalsJsonToJson(List<GoalsJson> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class GoalsJson {
  ...
  factory GoalsJson.fromJson(Map<String, dynamic> json) => GoalsJson(
