...
class AssistsWidget extends StatefulWidget  {
  ...
  AssistsWidget({this.id,this.name, this.lastname,this.image, this.club, this.position,
    this.nationality, this.age, this.matches, this.goals, this.assists, this.saves,this.rating});

  @override
  _PlayerWidgetState createState() => _PlayerWidgetState();
}

class _PlayerWidgetState extends State<AssistsWidget> {
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget> [
                    ...
                    Text("Assists: "+this.widget.assists, style: TextStyle( fontWeight:FontWeight.bold,
                      fontSize: 18.0,
                    )),
                    const SizedBox(height: 5.0, ),
                  ],
