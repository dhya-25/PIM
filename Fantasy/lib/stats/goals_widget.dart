...
class GoalsWidget extends StatefulWidget  {
  ...
  GoalsWidget({this.id,this.name, this.lastname,this.image, this.club, this.position,
...
class _PlayerWidgetState extends State<GoalsWidget> {
              ...
              children: <Widget>[
                ...
                Column(
                  ...
                  children: <Widget> [
                    ...
                    Text("Goals: "+this.widget.goals, style: TextStyle( fontWeight:FontWeight.bold,
                      fontSize: 18.0,
                    )),
                    const SizedBox(height: 5.0, ),
                  ],
