...
final String token = '73675428e57c4d34ab80c1f087db6e85';

class leagueStanding extends StatefulWidget{
  String leagueCode;
 
  Color leagueColor;
  leagueStanding(this.leagueCode,  this.leagueColor);

  @override
  createState() => leagueStandingState(leagueCode,  leagueColor);
}
...
class leagueStandingState extends State<leagueStanding> {
  ...
  Color leagueColor;
  leagueStandingState(this.leagueCode,  this.leagueColor);
                    ...
                    itemBuilder: (context, i){
                      ...
                      return Container(
                        decoration: BoxDecoration(
                         // color: leagueColor.withOpacity(0.0),
...
Future<List<teamStanding>> getLeagueStandings() async{
  String code="PL";
  Response r = await get(Uri.encodeFull('https://api.football-data.org/v2/competitions/$code/standings'),
      headers: {
        "X-Auth-Token" : token
      }
  );
