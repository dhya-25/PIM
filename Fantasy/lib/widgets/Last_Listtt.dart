...
import 'package:Fantasy/screens/detail_last.dart';
import 'package:Fantasy/models/last_model.dart';
import 'package:http/http.dart' as http;

class LastMatches extends StatelessWidget {
  final String idLeague;
  LastMatches(this.idLeague);

  Future<List<LastModel>> getMatchList() async{
    var url = "https://www.thesportsdb.com/api/v1/json/1/eventspastleague.php?id=4334";
